...
function medialab_social_share_acf(): void {
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'label'   => ' ',
                'name'    => 'ss_auto_insert_heading',
                'type'    => 'message',
                'message' => '<strong style="font-size:13px;">Automatische Einbindung</strong>',
                'default_value' => '',
            ),
            array(
                ...
                'ui'            => 1,
                'default_value' => 0,
                'instructions'  => 'Fügt Share-Buttons automatisch nach dem_content der ausgewählten Post-Types ein.',
                'wrapper'       => array( 'width' => '100' ),
            ),
            array(
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array(
                'key'           => 'field_ss_block_show_label',
                'label'         => 'Label anzeigen',
                'name'          => 'ss_block_show_label',
                'type'          => 'true_false',
                'ui'            => 1,
                'default_value' => 1,
                'wrapper'       => array( 'width' => '25' ),
