...
<head>
    ...
    <style id="ml-cf7-select-fix">
        /* CF7 Select: Theme-Bug – padding:24px 32px + height:48px (border-box)
           ergibt 0px Content-Bereich → Text wird nicht dargestellt.
        ...
        /* Datumsfeld: Format-Platzhalter dunkelgrau */
