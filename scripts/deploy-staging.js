...
const LOCAL_THEME = './cms/wp-content/themes/churum-meru-theme';
...
try {
  ...
  execSync(`rsync -avz --delete ${LOCAL_THEME}/ ${STAGING_SERVER}:${STAGING_PATH}/wp-content/themes/churum-meru-theme/`, {
    stdio: 'inherit'
  });
